    ...
    fetch('php_posts/fetch_posts.php')
        ...
        .then(posts => {
            if (!posts || posts.length === 0) {
                feedContainer.innerHTML = '<p class="text-center text-muted">No posts available.</p>';
                return;
            }
        ...
        .catch(error => {
            ...
            feedContainer.innerHTML = '<p class="text-center text-danger">Failed to load posts. Please try again later.</p>';
        });
});
